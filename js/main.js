    ...
    methods: {
        ...
        endGame() {
            ...
            if (this.score.zerg > this.score.protoss &&
                this.score.zerg > this.score.terann &&
                this.score.primal < 8 &&
            ...
            // Изначальный
                    ...
                    this.score.primal > this.score.terann &&
                    this.score.primal == 8) {
            ...
            // Протосс
                    ...
                    this.score.protoss > this.score.terann &&
            ...
            // Терран
            else if (this.score.terann > this.score.zerg && 
                    this.score.terann > this.score.protoss) {
                        this.goToResult('terann');
                        this.totalGame.terann++;
            }
            // Гибрид
